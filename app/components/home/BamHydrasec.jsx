...
import HydraImg from "../../assets/Home/HydraWater_Drop.svg";
import BalmImg from "../../assets/Home/StickBalmImg.svg";
import PatchImg from "../../assets/Home/PatchImg.svg";
import EyePatch1 from "../../assets/Home/EyeCare/EyePatchGold.svg";
import EyePatch2 from "../../assets/Home/EyeCare/EyePatchBlackPearl.svg";
import EyePatch3 from "../../assets/Home/EyeCare/VitaminC.svg";
const fadeVariant = {
    ...
    <section className="max-w-7xl mx-auto  px-4 md:px-16 py-16">
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: false, amount: 0.3 }}
        >
          <h2 className="font-[--font-lustria] text-[#76564D] text-[30px] md:text-[46px] font-regular mb-2">
            Hydra Water Drop
          </h2>
          <p className="font-[--font-lustria] uppercase text-[20px] tracking-wide text-[#76564D] mb-4">
            Essence Cream
          </p>
          <p className="font-[--font-raleway] text-[#000000] text-[18px] leading-relaxed mb-4">
          ...
          <p className="font-[--font-raleway] text-[#000000] text-[18px] leading-relaxed">
      ...
      >
        ...
        <motion.div
          ...
          custom={0.4}
        >
          <h2 className="font-[--font-lustria] text-[#4B2E2E] text-[28px] md:text-[42px] font-regular mb-2">
            Stick Balm
          </h2>
          <p className="font-[--font-raleway] text-[#5E4A4A] text-[18px] leading-relaxed mb-4">
          ...
          <p className="font-[--font-raleway] text-[#4B2E2E]  font-semibold mb-1">
            Benefits:
          </p>
          <ul className="font-[--font-raleway] list-disc list-inside text-[#5E4A4A] text-[15px] space-y-1">
...
export const EyeCare = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-10" id="cleansing">
      ...
      <p className="font-[--font-raleway] mt-2 text-[14px] md:text-[16px] text-[#000000] max-w-xs">
          ...
          >
            <div className="flex flex-col  h-full py-5">
              ...
              <motion.p
                ...
                transition={{ duration: 1, delay: 0.2 }}
                viewport={{ once: false, amount: 0.3 }}
                className="my-8 font-[--font-raleway] text-[18px] text-left font-light"
              >
                {item.title}
              </motion.p>
            </div>
